...
### 優先度1 - 高
- [ ] **プレビューダイアログ** - ファイル内容を表示するプレビュー機能
  - 2カラム表示（行番号 + コード）
  - シンタックスハイライト
  - ファイル内検索機能
- [ ] **ヘッダーコンポーネント** - アプリケーションヘッダー
  - モード切り替え（Normal/Gap）
  - アプリケーション名とバージョン表示

### 優先度2 - 中
- [ ] **チャット結果表示の改善**
  - チャットメッセージの表示（ユーザー/AI）
  - ソースファイルの表示（RAG検索結果）
  - ギャップ分析結果のカード表示
- [ ] **ステータス更新ループ**
  - CPU/RAM使用率のリアルタイム表示
...
1. **プレビューダイアログ** - ファイル内容を表示するプレビュー機能
2. **ヘッダーコンポーネント** - モード切り替え、アプリ名表示
